...
@Job.register(name="normalize_top_shareholders_to_owners")
class NormalizeTopShareholdersToOwners(LlmCallbackJob):
    requirements: Dict[str, Any] = {
        "cpu": 1,
        "gpu": 1,
    }

    label: str = "Normalize Top Shareholders Results"
    description: str = "Convers the results of a top shareholders search into a format matching the output from find owners."
